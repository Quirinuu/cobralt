...
<section class="section" id="historia" aria-labelledby="historia-title">
  <div class="section-inner">
    ...
    <div class="timeline" role="list">
      ...
      <div class="timeline-item" role="listitem" data-animate data-animate-delay="1"><div class="timeline-dot" aria-hidden="true"></div><div class="timeline-year">2010</div><h3>Fundação do CoBraLT</h3><p>Fundação oficial do Comitê Brasileiro das Ligas do Trauma, assumindo papel estratégico na articulação entre ligas, padronização de ações e fortalecimento institucional em todo o território nacional.</p></div>
