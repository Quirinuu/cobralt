...
return [
    'id' => '2026072501_news_only',
    'description' => 'Mantém somente as notícias da Gestão 2026 e do Dr. Wellington.',
    'up' => static function (PDO $db): void {
        $authorId = $db->query('SELECT MIN(id) FROM admin_users')->fetchColumn();
        if (!$authorId) {
            throw new RuntimeException('Nenhum usuário administrativo disponível para assinar as notícias.');
        }
