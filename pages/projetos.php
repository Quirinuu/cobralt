  ...
  <div class="section-inner">
    <div class="programs-feature" data-animate>
      <div class="programs-feature-head">
        ...
        <a href="#publicacoes" class="news-link" style="font-size:0.82rem;">Ver publicações →</a>
      </div>
    ...
    <div id="publicacoes" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:1.5rem;">
