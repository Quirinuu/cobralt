...
$pdfFile = 'programa-salvando-vidas-anafilaxia.pdf';
$pdfDownloadName = 'Programa Salvando Vidas - Reação Alérgica Grave e Anafilaxia.pdf';
...
layout_head(
  'Salvando Vidas - Reação Alérgica Grave e Anafilaxia',
  'Material do Programa Salvando Vidas sobre reações alérgicas graves, anafilaxia, prevenção, reconhecimento e condutas iniciais.'
);
...
<div class="page-hero">
  <div class="page-hero-inner">
    <nav class="breadcrumb">
      <a href="../index.php">Início</a><span>›</span><a href="projetos.php">Projetos</a><span>›</span><a href="programa-salvando-vidas-2026.php">Salvando Vidas 2026</a><span>›</span><span>Anafilaxia</span>
    </nav>
    <div class="page-hero-label">Material educativo</div>
    <h1 class="page-hero-title">Reação Alérgica Grave e Anafilaxia</h1>
    <p class="page-hero-sub">Publicação do Programa Salvando Vidas 2026 voltada ao reconhecimento, prevenção e abordagem inicial de reações alérgicas graves e anafilaxia.</p>
    <div class="region-stats">
      <div class="region-stat"><div class="region-stat-value">37</div><div class="region-stat-label">páginas</div></div>
  ...
  <div class="section-inner" style="max-width:1080px;">
    <div class="document-layout">
      <div class="document-summary" data-animate>
        ...
        <p>O documento apresenta uma revisão didática sobre reações alérgicas graves e anafilaxia, explicando conceitos básicos, epidemiologia, prevenção, fisiopatologia, principais causas e manifestações clínicas.</p>
        <p>A publicação também orienta sobre reconhecimento de sinais de gravidade, diagnóstico diferencial, tratamento, complicações, urticária, angioedema e alergias, com bloco de questões para apoio às ações educativas das ligas.</p>
      ...
      <div class="document-highlights" data-animate data-animate-delay="1">
        ...
        <ul>
          <li>Explica a diferença entre reação alérgica, reação grave e anafilaxia.</li>
          <li>Aborda fatores desencadeantes como alimentos, medicamentos, insetos e látex.</li>
          <li>Organiza sinais cutâneos, respiratórios, gastrointestinais e cardiovasculares.</li>
          <li>Inclui prevenção, tratamento, complicações e questões para treinamento.</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="pdf-viewer-shell" data-animate>
      <div class="pdf-viewer-header">
        <div>
          ...
          <h2 class="pdf-viewer-title" id="pdf-viewer-title">Reação Alérgica Grave e Anafilaxia</h2>
        </div>
      ...
      <object class="pdf-frame" data="<?= htmlspecialchars($pdfViewerUrl) ?>" type="application/pdf" aria-label="Visualizador do material Reação Alérgica Grave e Anafilaxia">
