...
$pdfFile = 'programa-salvando-vidas-avc-iam.pdf';
$pdfDownloadName = 'AVC e IAM - Programa Salvando Vidas.pdf';
...
layout_head(
  'Salvando Vidas - AVC e IAM',
  'Material do Programa Salvando Vidas sobre reconhecimento de AVC e infarto agudo do miocardio, sinais de alerta e orientacoes iniciais.'
);
...
<div class="page-hero">
  <div class="page-hero-inner">
    ...
    <p class="page-hero-sub">Publicação do Programa Salvando Vidas 2026 voltada ao reconhecimento precoce de acidente vascular cerebral e infarto agudo do miocárdio, com orientações iniciais para ações educativas.</p>
    <div class="region-stats">
      <div class="region-stat"><div class="region-stat-value">44</div><div class="region-stat-label">páginas</div></div>
  ...
  <div class="section-inner" style="max-width:1080px;">
    <div class="document-layout">
      <div class="document-summary" data-animate>
        ...
        <p>O documento apresenta conteúdo educativo sobre AVC e IAM, destacando sinais de alerta, importância do reconhecimento precoce e necessidade de acionamento rápido dos serviços de urgência.</p>
        <p>A publicação apoia ações das ligas com explicações diretas para o público leigo, reforçando prevenção, fatores de risco, condutas iniciais seguras e orientação sobre quando buscar atendimento imediato.</p>
      ...
      <div class="document-highlights" data-animate data-animate-delay="1">
        ...
        <ul>
          <li>Apresenta sinais de alerta para AVC e infarto agudo do miocárdio.</li>
          <li>Reforça a importância do tempo-resposta e do atendimento imediato.</li>
          <li>Organiza orientações iniciais para comunicação com o público leigo.</li>
    ...
    <div class="pdf-viewer-shell" data-animate>
      <div class="pdf-viewer-header">
        <div>
          ...
          <h2 class="pdf-viewer-title" id="pdf-viewer-title">AVC e IAM</h2>
        </div>
      ...
      <object class="pdf-frame" data="<?= htmlspecialchars($pdfViewerUrl) ?>" type="application/pdf" aria-label="Visualizador do material AVC e IAM">
