...
$pdfFile = 'trauma-boletime-agosto-2026.pdf';
$pdfDownloadName = 'Trauma BoleTIME - Agosto 2026.pdf';
...
layout_head(
  'Trauma BoleTIME - Agosto 2026',
  'Segunda edição do Trauma BoleTIME, boletim trimestral do CoBraLT, com os destaques do terceiro trimestre de 2026.'
);
...
<div class="page-hero">
  <div class="page-hero-inner">
    <nav class="breadcrumb">
      <a href="../index">Início</a><span>›</span><a href="boletimes">Trauma BoleTIME</a><span>›</span><span>Agosto 2026</span>
    </nav>
    <div class="page-hero-label">Edição 2 · 3º trimestre/2026</div>
    <h1 class="page-hero-title">Trauma BoleTIME - Agosto 2026</h1>
    <p class="page-hero-sub">A segunda edição do informativo trimestral do CoBraLT reúne os principais acontecimentos institucionais, científicos e acadêmicos do terceiro trimestre de 2026.</p>
    <div class="region-stats">
      <div class="region-stat"><div class="region-stat-value">12</div><div class="region-stat-label">páginas</div></div>
      <div class="region-stat"><div class="region-stat-value">2ª</div><div class="region-stat-label">edição</div></div>
      <div class="region-stat"><div class="region-stat-value">2026</div><div class="region-stat-label">3º trimestre</div></div>
    </div>
  </div>
</div>
  ...
  <div class="section-inner" style="max-width:1080px;">
    <div class="document-layout">
      <div class="document-summary" data-animate>
        ...
        <p>A segunda edição do Trauma BoleTIME registra um período de grandes conquistas para o CoBraLT, com o fortalecimento da formação acadêmica, a ampliação da presença nacional e internacional e uma nova fase de organização institucional.</p>
        <p>O boletim traz a cobertura do XXVIII CoLT e do II COTREM, que reuniram mais de 600 participantes em Formosa, entrevista com o Dr. Wellington Santos, a preparação para a 5ª Onda Amarela e reportagens sobre prevenção, inovação, congressos e projetos das ligas.</p>
      ...
      <div class="document-highlights" data-animate data-animate-delay="1">
        ...
        <ul>
          <li>XXVIII CoLT e II COTREM reúnem mais de 600 participantes de mais de 20 estados em Formosa.</li>
          <li>Entrevista com o Dr. Wellington Santos sobre formação, liderança e o futuro da assistência ao trauma.</li>
          <li>5ª Onda Amarela leva a produção acadêmica brasileira ao congresso pan-americano em Cartagena.</li>
          <li>CoBraLT conquista CNPJ próprio e inicia uma nova fase de autonomia e governança institucional.</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="pdf-viewer-shell" data-animate>
      <div class="pdf-viewer-header">
        <div>
          ...
          <h2 class="pdf-viewer-title" id="pdf-viewer-title">Trauma BoleTIME - Agosto 2026</h2>
        </div>
      ...
      <object class="pdf-frame" data="<?= htmlspecialchars($pdfViewerUrl) ?>" type="application/pdf" aria-label="Visualizador do Trauma BoleTIME - Agosto 2026">
