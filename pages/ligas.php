...
if (pb_render_managed_page_if_exists('ligas', 'ligas')) { exit; }
...
<section class="section" id="beneficios" style="background:linear-gradient(180deg,var(--off-white) 0%,#fff 100%);" aria-labelledby="beneficios-title">
  <div class="section-inner" style="max-width:960px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1.25rem;margin-top:2rem;">
      ...
      <div class="benefit-card" data-animate data-animate-delay="2"><div class="benefit-icon">🎓</div><div class="benefit-content"><h4>Congressos com Desconto</h4><p>Condições especiais nos <strong>CoLTs, congressos parceiros</strong> e atividades futuras organizadas pela rede CoBraLT.</p></div></div>
