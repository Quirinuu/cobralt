...
if (pb_render_managed_page_if_exists('regiao-sudeste-rjes', 'ligas')) { exit; }
...
<nav class="regions-nav" aria-label="Regiões">
  <div class="regions-nav-inner">
    ...
    <a href="regiao-sudeste-mg">Sudeste – MG</a>
    <a href="regiao-sudeste-sp">Sudeste – SP</a>
    <a href="regiao-sudeste-rjes" class="active">Sudeste – RJ/ES</a>
