...
$pdfFile = 'programa-salvando-vidas-controle-hemorragias.pdf';
$pdfDownloadName = 'Programa Salvando Vidas - Controle de Hemorragias.pdf';
...
layout_head(
  'Salvando Vidas - Controle de Hemorragias',
  'Material do Programa Salvando Vidas sobre controle de hemorragias, pressão direta, torniquetes, Stop the Bleed e prevenção.'
);
...
<div class="page-hero">
  <div class="page-hero-inner">
    <nav class="breadcrumb">
      <a href="../index.php">Início</a><span>›</span><a href="projetos.php">Projetos</a><span>›</span><a href="programa-salvando-vidas-2026.php">Salvando Vidas 2026</a><span>›</span><span>Controle de Hemorragias</span>
    </nav>
    <div class="page-hero-label">Material educativo</div>
    <h1 class="page-hero-title">Controle de Hemorragias</h1>
    <p class="page-hero-sub">Publicação do Programa Salvando Vidas 2026 sobre identificação e controle precoce de sangramentos graves em situações de trauma.</p>
    <div class="region-stats">
      <div class="region-stat"><div class="region-stat-value">34</div><div class="region-stat-label">páginas</div></div>
      <div class="region-stat"><div class="region-stat-value">Junho</div><div class="region-stat-label">ciclo 2026</div></div>
  ...
  <div class="section-inner" style="max-width:1080px;">
    <div class="document-layout">
      <div class="document-summary" data-animate>
        ...
        <p>O documento apresenta a hemorragia como uma das principais causas de morte evitável no trauma e destaca a importância do controle precoce do sangramento dentro da abordagem inicial do paciente traumatizado.</p>
        <p>A publicação explica volume sanguíneo, fisiopatologia da perda sanguínea, classificação da hemorragia, técnicas de controle, pressão direta, torniquetes, agentes hemostáticos, preenchimento de feridas, Stop the Bleed, reanimação volêmica, ácido tranexâmico, prevenção e questões práticas.</p>
      ...
      <div class="document-highlights" data-animate data-animate-delay="1">
        ...
        <ul>
          <li>Contextualiza o trauma e a hemorragia como causas relevantes de mortalidade evitável.</li>
          <li>Explica a abordagem xABCDE e o controle imediato de hemorragias externas graves.</li>
          <li>Detalha pressão direta, curativo compressivo, wound packing, hemostáticos e torniquetes.</li>
          <li>Inclui Stop the Bleed, reanimação volêmica, transfusão maciça, prevenção e questões.</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="pdf-viewer-shell" data-animate>
      <div class="pdf-viewer-header">
        <div>
          ...
          <h2 class="pdf-viewer-title" id="pdf-viewer-title">Controle de Hemorragias</h2>
        </div>
      ...
      <object class="pdf-frame" data="<?= htmlspecialchars($pdfViewerUrl) ?>" type="application/pdf" aria-label="Visualizador do material Controle de Hemorragias">
